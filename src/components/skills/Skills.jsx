...
const skillsData = {
    frontend: [
        { id: 1, title: "React", proficiency: 75 },
        {
            id: 2,
            title: "JavaScript",
    ...
    backend: [
        { id: 7, title: "Nodejs", proficiency: 70 },
        { id: 8, title: "Express", proficiency: 40 },
        { id: 9, title: "MongoDB", proficiency: 30 },
        { id: 10, title: "mySQL", proficiency: 50 },
    ],
    tools: [
        { id: 11, title: "GitHub", proficiency: 85 },
        { id: 13, title: "Netlify", proficiency: 85 },
    ...
    return (
        ...
        >
            <div className="container mx-auto px-4">
                ...
                {/* Category Tabs */}
                <div className="flex flex-col sm:flex-row justify-center mb-10 gap-2 sm:gap-0">
                    {/* "All Skills" on top in mobile view */}
                    <div  className={`flex justify-center  rounded-md ${
                        isDarkMode ? "bg-gray-700" : "bg-gray-200"
                    }`}> 
                        <button
                            className={`px-4 py-2 text-sm font-medium rounded-md transition w-full sm:w-auto ${
                                activeTab === "all"
                                    ? isDarkMode
                ...
                {/* Other tabs */}
                <div
                    className={`inline-flex rounded-lg p-1 justify-center sm:ml-4 ${
                        isDarkMode ? "bg-gray-700" : "bg-gray-200"
                    }`}>
                    <button
